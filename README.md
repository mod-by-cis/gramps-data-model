...
<ul>
  ...
  <li><a href="#ConvertedFromOfficialtd"><button>3️⃣🅰️: Files converted from official DTD GrampsXML</button></a> | <a href="#ConvertedFromOfficialRng"><button>3️⃣🅱️: Files converted from official RNG GrampsXML</button></a></li>
</ul>
